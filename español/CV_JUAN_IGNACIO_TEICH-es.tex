...
\newcommand{\cvpersonalinfolinewithiconsvg}[3]{
    % icon, vertically aligned with text (see https://tex.stackexchange.com/a/129463)
    \raisebox{.5\fontcharht\font`E-.5\height}{\includesvg[#1]{#2}}
    % text
    #3
...
\cvpersonalinfo{
    % photo
    \includegraphics[height=36mm]{../logos-photos/photo-JIT-2023.jpg}
}{
    % name
...
\cvitem{
  ...
  \end{minipage} \\
  \vspace{0.3cm}
  \cvdurationstyle{Diciembre 2024 -- Presente}\\
}{
	
  \cvtitle{Ingeniero de Diseño Termohidráulico y Cálculo Fluidodinámico}
  % \textbf{\large Nucleoeléctrica Argentina S.A.}
  \cvsubtitlestyle{Nucleoeléctrica Argentina S.A.}
  
  Desarrollo cálculos termohidraulicos, simulaciones de fluidos por CFD y códigos termohidráulicos para asegurar la
  operación y seguridad de las Centrales Nucleares Atucha I, Atucha II y Embalse.

  Principales tareas:
  \begin{itemize}
    \item Desarrollo de código de simulación de ondas de presión y golpe de ariete en cañerías por medio del Método de
        las Características.
    \item Simulaciones CFD con software ANSYS Fluent y ANSYS CFX, realizando todo el proceso necesario: preparación de
        la geometría, mallado de la misma, set-up de la simulación y post-proceso de los resultados.
    \item Mantenimiento de códigos internos en Perl, Fortran, C++, Python.
    \item Desarrollo de informes técnicos.
    \item Proyectos destacables:
    \begin{itemize}
        \item Cálculo térmico del nuevo Almacenamiento en Seco para Combustibles Gastados de la CN Atucha II.
        \item Cálculo de las solicitaciones por golpe de ariete en las cañerías del Sistema de Inyección de Boro de la CN Atucha I.
        \item Cálculo de Potencias Límite de Canal de la CN Atucha II.
    \end{itemize}
  \end{itemize}

  Skills and tools:
  \begin{itemize}
      \item ANSYS (Fluent, CFX, Discovery, Mesh, Workbench), CFD, C++, Dinámica de Fluidos, Transferencia de Calor y Masa, Método de las Características, Python.
  \end{itemize}
...
\cvitem{
    \cvdurationstyle{2025 -- 2027}
}{
    \begin{minipage}{0.1\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{../logos-photos/Logo_FIUBA.png}   
    \end{minipage}      
    \cvtitle{Maestría en Inteligencia Artificial}

    Facultad de Ingeniería, Universidad de Buenos Aires
    
    \begin{itemize}[leftmargin=*]
        \item En curso la Especialización en Inteligencia Artificial (año 1/2 de la Maestría)
    \end{itemize}
}
